...
env = Environment(num_satellites=num_satellites, debris_speed=debris_speed, initial_positions=initial_positions, initial_debris_position=initial_debris_position)
...
episodes = 100  # Adjusted for quick testing
timesteps = 80  # Adjusted for quick testing
epsilon = 0.75
epsilon_min = 0.01
epsilon_decay = 0.98
gamma = 0.95  # Discount rate
batch_size = 10  # Adjusted for quick testing
memory = []

for e in range(episodes):
    print('Training... episode:', e+1, '/', episodes)
    state = env.reset()
...
# Save the model
model.save("satellite_model3_upperright_morereward2.h5")
